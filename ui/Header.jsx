...
export function Header() {
  ...
  return (
    <header className="flex justify-between items-center p-4 bg-white">
      ...
      {/* ナビゲーションメニュー */}
      <div className={`fixed inset-y-0 right-0 transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out bg-white shadow-lg p-4 z-50 md:hidden`}>
